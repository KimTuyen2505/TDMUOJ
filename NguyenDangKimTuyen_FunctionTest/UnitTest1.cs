...
namespace NguyenDangKimTuyen_FunctionTest
{
    [TestFixture]
    public class Unitest
    {
        ...
        public void TC_REG_01_Register_Successful()
        {
            ...
            driver.FindElement(By.Name("username")).SendKeys("teacherquynhnga");
            driver.FindElement(By.Name("email")).SendKeys("teacherquynhnga@gmail.com");
